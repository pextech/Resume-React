      ...
      <div className="w-1/2 p-20 xs:w-full about" data-aos="fade-up">
        ...
        <div className="mt-20 w-full description font-light text-gray-600 editor">
          ...
          <p className="mt-10">
            ...
            {' '}
            <a href="https://minorityprogrammers.com/" target="_blank" className="text-blue-500  hover:text-primary-100"> MPA </a>
            {' '}
            {' '}
            <a href="https://www.techenfold.com/" target="_blank" className="text-blue-500  hover:text-primary-100"> TechEnfold, </a>
            {' '}
            {' '}
