...
function Blogs({
  ...
  return (
    <div className="blogs flex flex-col w-5/12 bg-gray-100 rounded-md m-10">
      {/* blog section */}
      <img src={image} alt="future" className="w-full h-full rounded-md rounded-b-none" />
      ...
      <div className="description ml-10 my-6 font-light text-gray-700">
        <p>
          {description}
        </p>
      </div>
      <div className="readmore ml-10 mb-10">
        <button type="button" className="border border-gray-700 w-40 h-12 shadow-md rounded-md">Read More</button>
      </div>
    </div>
  );
}
